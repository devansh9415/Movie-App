...
const About = () => {
  ...
  const githubClick = () => {
    setButtonLink("https://github.com/devansh9415");
  };

  const websiteClick = () => {
    setButtonLink("https://www.linkedin.com/in/devansh7607/");
  };
          ...
          <div className="card grey lighten-3 hoverable">
            <div className="card-content black-text">
              ...
              <p>
                ...
                <i className="tiny material-icons">copyright</i> 2021
              </p>
            </div>
            <div className="card-action">
              <form action={buttonLink} target="_blank">
                ...
                >
                  Linkedin
                  <i className="small material-icons right">person_add</i>
                </button>
              </form>
            </div>
          </div>
